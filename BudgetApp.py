...
def deposit(strvar):
    userAmount = input("Enter amount to deposit: ")
    userAmount = float(userAmount)
    strvar.deposit(userAmount)
    return userAmount

def transfer(strvar, strvar1, floatvar):
    # userAmount = input("Enter amount to transfer: ")
    # userAmount = float(userAmount)
    # location = input("Where to transfer?: ")
    # location.transfer(userAmount)
    # # strvar.transfer(userAmount, location.balance)
    # return userAmount
    userAmount = input("Enter amount to transfer: ")
    userAmount = float(userAmount)
    to_location = input("Where to tranfer?: ")
    to_location.balance += userAmount
...
# print(food.balance,clothing.balance)


print("current balance: ", food.balance)
withdrawal(food)
print("new balance: ", food.balance)
deposit(food)
print("new balance: ", food.balance)
transfer(food, clothing, userInput)
print(food.balance)
